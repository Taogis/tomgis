...
def test_lanenet(checkpoint_path, crop_height, crop_width, model, dataset):
    # Get the names of the classes so we can record the evaluation results
    print("Retrieving dataset information ...")
    #class_names_list, label_values = helpers.get_label_info(os.path.join(args.dataset, "class_dict.csv"))
    class_names_list, label_values = helpers.get_label_info(os.path.join("/home/mmtao/test/Semantic-Segmentation-Suite/CamVid/", "class_dict.csv"))
    class_names_string = ""
    ...
    #os.environ["CUDA_VISIBLE_DEVICES"] = "1"  #set the GPU device ,tmm
    ...
    train_input_names,train_output_names, val_input_names, val_output_names, test_input_names, test_output_names = utils.prepare_dataForLaneNet(dataset_dir=args.dataset)
    ...
    for ind in range(len(test_input_names)):
        ...
        gt = utils.load_outputimage(test_output_names[ind])[:args.crop_height, :args.crop_width]
...
if __name__ == '__main__':
    # init args
    args = init_args()
    args.checkpoint_path = '/home/mmtao/test/Semantic-Segmentation-Suite/checkpoints/latest_model_BiSeNet_CamVid.ckpt'
    args.model = 'BiSeNet'
    args.dataset = 'CamVid'


    os.environ["CUDA_VISIBLE_DEVICES"] = "3"  # BY TMM

    test_lanenet(args.checkpoint_path, 512, 512, args.model, args.dataset)

"""
python ./test\ \(copy\).py --checkpoint_path /home/mmtao/test/Semantic-Segmentation-Suite/checkpoints/latest_model_BiSeNet_CamVid.ckpt --model BiSeNet --dataset /home/mmtao/lanenet-lane-detection/lanenet-lane-detection/data/tusimple_test_image/saveimg 
"""